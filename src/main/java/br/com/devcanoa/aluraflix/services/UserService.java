...
import br.com.devcanoa.aluraflix.exception.user.UserAlreadyExistsException;
import br.com.devcanoa.aluraflix.exception.user.UserNotFoundException;
...
import br.com.devcanoa.aluraflix.repository.UserRepository;
...
public class UserService {
    ...
    public JwtResponse authenticateUser(@Valid LoginRequest loginRequest) {
        ...
        return JwtResponse.from(jwt, userDetails, roles.get(0));
    }
    ...
    private void validateEmailAndUsername(@Valid SignupRequest signupRequest) {
